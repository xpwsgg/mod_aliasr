...
SER_SRCS=mod_aliasr.cpp

SDK_LIBS=-L./NlsSdk3.X/lib -lpthread  -lalibabacloud-idst-speech -lpthread -lrt -lz -ldl -lanl -D_GLIBCXX_USE_CXX11_ABI=0
SDK_INCLUDE=-I./NlsSdk3.X/include
